function createUnityInstance(r, n, l) {
    ...
    function t(e) {
        var r = e.reason || e.error, n = r ? r.toString() : e.message || e.reason || "",
    ...
    }), window.addEventListener("error", t), window.addEventListener("unhandledrejection", t), c.deinitializers.push(function () {
        for (var e in c.disableAccessToMediaDevices(), a.forEach(function (e) {
            r.removeEventListener(e, i)
        }), window.removeEventListener("error", t), window.removeEventListener("unhandledrejection", t), c.intervals) window.clearInterval(e);
        c.intervals = {}
    ...
    var d = "", u = "", f = (document.addEventListener("webkitfullscreenchange", function (e) {
    ...
    function g(e, r) {
        if ("symbolsUrl" != e) {
            var n = c.downloadProgress[e], t = (n = n || (c.downloadProgress[e] = {
                    started: !1,
                    finished: !1,
                    lengthComputable: !1,
                    total: 0,
    ...
    function p() {
        ...
        g(n = "dataUrl"), e = c.fetchWithProgress, r = c[n], r = /file:\/\//.exec(r) ? "same-origin" : void 0;
        var n, e, r, t = e(c[n], {
            method: "GET",
        ...
        c.preRun.push(function () {
            c.addRunDependency("dataUrl"), t.then(function (e) {
                ...
                for (n += 4; n < o;) {
                    var a = r.getUint32(n, !0), i = (n += 4, r.getUint32(n, !0)), s = (n += 4, r.getUint32(n, !0)),
    ...
    return c.SystemInfo = function () {
        ...
        for (var s = 0; s < a.length; ++s) if (r = i(a[s][0] + "[/ ](.*?)[ \\)]", o, 1)) {
            e = a[s][1];
            break
        }
        "Safari" == e && (r = i("Version/(.*?) ", o, 1)), "Internet Explorer" == e && (r = i("rv:(.*?)\\)? ", o, 1) || r);
        for (var l = [["Windows (.*?)[;)]", "Windows"], ["Android ([0-9_.]+)", "Android"], ["iPhone OS ([0-9_.]+)", "iPhoneOS"], ["iPad.*? OS ([0-9_.]+)", "iPadOS"], ["FreeBSD( )", "FreeBSD"], ["OpenBSD( )", "OpenBSD"], ["Linux|X11()", "Linux"], ["Mac OS X ([0-9_\\.]+)", "MacOS"], ["bot|google|baidu|bing|msn|teoma|slurp|yandex", "Search Bot"]], d = 0; d < l.length; ++d) if (c = i(l[d][0], o, 1)) {
        ...
        var u, c = {
            ...
            f = ((f = document.createElement("canvas")) && (u = (h = f.getContext("webgl2")) ? 2 : 0, h || (h = f && f.getContext("webgl")) && (u = 1), h && (t = h.getExtension("WEBGL_debug_renderer_info") && h.getParameter(37446) || h.getParameter(7937))), "undefined" != typeof SharedArrayBuffer),
        ...
        var e = a.body ? a.body.getReader() : void 0, l = void 0 !== a.headers.get("Content-Length"),
            d = function (e, r) {
                if (!r) return 0;
            ...
            }(a, l), u = new Uint8Array(d), c = [], f = 0, h = 0;
        return l || console.warn("[UnityCache] Response is served without Content-Length header. Please reconfigure server to include valid Content-Length for better download performance."), function o() {
        ...
        c.SystemInfo.hasWebGL ? 1 == c.SystemInfo.hasWebGL ? r('Your browser does not support graphics API "WebGL 2" which is required for this content.') : c.SystemInfo.hasWasm ? (1 == c.SystemInfo.hasWebGL && c.print('Warning: Your browser does not support "WebGL 2" Graphics API, switching to "WebGL 1"'), c.startupErrorHandler = r, l(0), c.postRun.push(function () {
